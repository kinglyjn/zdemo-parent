 ...
 */
@Configuration
@PropertySource("/mybatis01/jdbc.properties")
@ComponentScan("mybatis01")         // 配置 spring 扫描组件的路径
@MapperScan("mybatis01.mapper")     // 配置 mybatis-spring 扫描 mapper 接口的路径
...
public class MyConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory01(@Qualifier("dataSource01")  DataSource dataSource) throws IOException {
        ...
        factoryBean.setConfigLocation(new DefaultResourceLoader().getResource("/mybatis01/mybatis-config.xml"));

        Resource[] resources = new PathMatchingResourcePatternResolver().getResources("classpath*:/mybatis01/*/**/*.xml");
